    ...
    <div>
      <nav className="flex items-center">
        <div className="flex items-center justify-between w-full">
          ...
          <div>
            <h1 className="ml-auto relative text-yellow-400 text-2xl sm:text-xl md:text-2xl" >
            If You Have Pool Needs, We&apos;re in the Business
            </h1>
          </div>
          <div className='p-3'>
            <a href='#services'className="flex relative text-blue-500">Services</a>
            <Link className='text-blue-500 flex relative' href='/about'>About</Link>
